...
4.  **Analyse outliers** using hierarchical sigma-based detection
...
# Section 5: Templates for custom analysis
...
**Examples**: - Explore relationships between traits and mechanical properties - Create scatter plots comparing different measurements - Filter data by family or species - Analyse trends across different sample types
